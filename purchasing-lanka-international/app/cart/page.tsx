...
import { FaShoppingCart, FaTrash, FaMinus, FaPlus, FaTruck, FaArrowLeft, FaStore } from 'react-icons/fa';

// Mock cart data (replace with your actual cart context/state management)
const mockProducts = [
...
export default function CartPage() {
  ...
  // Apply coupon code
  const applyCoupon = () => {
    if (couponCode.toUpperCase() === 'FIRST10' || couponCode.toUpperCase() === 'WELCOME') {
  ...
  return (
    // Changed the background color from bg-gray-950 to bg-black to match the about page
    <section className="px-4 md:px-16 py-16 bg-black">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          {/* Steps indicator (shown only during checkout) */}
          {checkoutStep > 1 && checkoutStep < 4 && (
            <div className="bg-gray-900 p-2 rounded-full flex">
              <div className={`px-3 py-1 rounded-full ${checkoutStep === 2 ? 'bg-white text-black' : 'text-gray-400'}`}>
                Delivery
              </div>
              <div className={`px-3 py-1 rounded-full ${checkoutStep === 3 ? 'bg-white text-black' : 'text-gray-400'}`}>
                Review
              </div>
            </div>
          )}
        ...
        {cartItems.length === 0 && checkoutStep === 1 && (
          <div className="bg-gray-900 p-8 rounded-lg text-center">
            <FaShoppingCart className="text-gray-600 text-6xl mx-auto mb-6" />
            ...
            <div className="lg:col-span-2">
              ...
              {availableSupermarkets.length > 1 && (
                <div className="bg-gray-900 p-4 rounded-lg mb-4">
                  <h2 className="text-xl text-white mb-3">Choose Supermarket</h2>
                  <p className="text-gray-400 mb-3">You have items from multiple supermarkets. Please select one to proceed:</p>
                  <div className="flex flex-wrap gap-2">
                    {availableSupermarkets.map(supermarket => (
                      <button 
                        key={supermarket}
                        className={`px-4 py-2 rounded-full ${selectedSupermarket === supermarket ? 'bg-white text-black' : 'bg-gray-800 text-white hover:bg-gray-700'}`}
              ...
              <div className="bg-gray-900 rounded-lg overflow-hidden">
                <div className="hidden md:grid md:grid-cols-12 text-gray-400 p-4 border-b border-gray-800">
                ...
                {filteredItems.map(item => (
                  <div key={item.id} className="p-4 border-b border-gray-800 flex flex-col md:grid md:grid-cols-12 gap-4 items-center">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-900 p-4 rounded-lg">
                ...
                <button
                  ...
                  className={`w-full bg-white text-black py-3 rounded hover:bg-gray-300 transition flex items-center justify-center ${
                ...
                {subtotal < 5000 && (
                  <p className="text-gray-400 text-sm mt-4 text-center">
                    Add Rs. {(5000 - subtotal).toLocaleString()} more to get FREE delivery!
                  </p>
                )}
              </div>
            </div>
        ...
        {checkoutStep === 4 && (
          <div className="bg-gray-900 p-8 rounded-lg text-center">
            <div className="w-24 h-24 rounded-full bg-green-900 mx-auto mb-6 flex items-center justify-center">
